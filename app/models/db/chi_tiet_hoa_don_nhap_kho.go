...
type Chi_tiet_hoa_don_nhap_kho struct {
	...
	Hoa_don_nhap_kho 	Hoa_don_nhap_kho 	`json:"hoa_don_nhap_kho" gorm:"foreignKey:Hoa_don_id;constraint:OnDelete:CASCADE"`
	San_pham 			San_pham 			`json:"san_pham" gorm:"foreignKey:San_pham_id;constraint:OnDelete:CASCADE"`
	Chi_tiet_san_pham 	Chi_tiet_san_pham 	`json:"chi_tiet_san_pham" gorm:"foreignKey:Ctsp_id;constraint:OnDelete:CASCADE"`
}